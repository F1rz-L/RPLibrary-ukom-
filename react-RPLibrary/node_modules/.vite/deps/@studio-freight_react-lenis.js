...
function g({ lazy: r3 = false, debounce: c2 = 500, box: s2 = "border-box", callback: u2 = () => {
} } = {}, a3 = []) {
...
function O({ ignoreTransform: r3 = false, ignoreSticky: c2 = true, lazy: s2 = false, debounce: u2 = 500, callback: a3 = () => {
} } = {}) {
...
function clsx() {
  for (var e3, t3, f2 = 0, n3 = "", o3 = arguments.length; f2 < o3; f2++)
    (e3 = arguments[f2]) && (t3 = r2(e3)) && (n3 && (n3 += " "), n3 += t3);
  return n3;
}
...
function b2(r3, e3 = [], t3 = 0) {
  const { lenis: n3, addCallback: o3, removeCallback: a3 } = function() {
    const r4 = (0, import_react3.useContext)(m2), e4 = d();
...
var y2 = (0, import_react3.forwardRef)((o3, a3) => {
  var { children: f2, root: p = false, options: b3 = {}, autoRaf: y3 = true, rafPriority: v = 0, className: O2 } = o3, g2 = function(r3, e3) {
    var t3 = {};
    for (var n3 in r3)
  ...
  const h = (0, import_react3.useRef)(), w = (0, import_react3.useRef)(), [k2, N] = (0, import_react3.useState)(), j = (0, import_react3.useRef)([]), C = (0, import_react3.useCallback)((r3, e3) => {
  ...
  (0, import_react3.useImperativeHandle)(a3, () => ({ wrapper: h.current, content: w.current, lenis: k2 }), [k2]), (0, import_react3.useEffect)(() => {
    const r3 = new Lenis(Object.assign(Object.assign({}, b3), !p && { wrapper: h.current, content: w.current }));
    return N(r3), () => {
      r3.destroy(), N(void 0);
    };
  }, [p, JSON.stringify(b3)]), m((r3) => {
